...
const risk_prediction_entity_1 = require("./entities/risk-prediction.entity");
let PatientModule = class PatientModule {
};
exports.PatientModule = PatientModule;
exports.PatientModule = PatientModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([patient_profile_entity_1.PatientProfile, risk_prediction_entity_1.RiskPrediction])],
