...
let XrayController = class XrayController {
    ...
    async uploadFile(file, req) {
        ...
        try {
            ...
            throw new common_1.InternalServerErrorException(error.message || 'Upload processing failed');
        }
    }
    async getMyXrays(req) {
...
], XrayController.prototype, "uploadFile", null);
__decorate([
    (0, common_1.Get)('my-xrays'),
    __param(0, (0, common_1.Request)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object]),
    __metadata("design:returntype", Promise)
], XrayController.prototype, "getMyXrays", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], XrayController.prototype, "getXray", null);
exports.XrayController = XrayController = __decorate([
    (0, common_1.Controller)('xray'),
    (0, common_1.UseGuards)(jwt_auth_guard_1.JwtAuthGuard),
    __metadata("design:paramtypes", [xray_service_1.XrayService])
], XrayController);
