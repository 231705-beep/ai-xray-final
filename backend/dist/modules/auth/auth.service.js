...
let AuthService = class AuthService {
    ...
    async login(loginDto) {
        ...
        if (!user) {
            ...
            throw new common_1.UnauthorizedException('Email not found. Please register first.');
        }
        ...
        if (!isMatch) {
            ...
            throw new common_1.UnauthorizedException('Incorrect password. Please check your credentials.');
        }
