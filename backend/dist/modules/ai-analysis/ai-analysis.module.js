...
const ai_finding_entity_1 = require("./entities/ai-finding.entity");
...
exports.AiAnalysisModule = AiAnalysisModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([ai_report_entity_1.AIReport, xray_entity_1.XRay, ai_finding_entity_1.AIFinding, medical_case_reference_entity_1.MedicalCaseReference])],
